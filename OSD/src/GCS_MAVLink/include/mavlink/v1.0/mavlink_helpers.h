 ...
 * @endcode
 */
MAVLINK_HELPER uint8_t _mavlink_parse_char(uint8_t chan, uint8_t c, mavlink_message_t** r_message, mavlink_status_t** r_mavlink_status)
{
        /*
